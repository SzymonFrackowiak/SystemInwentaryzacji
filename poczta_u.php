               ...
               <div class="container-fluid">
                   <div class="row">
                       ...
                       <table class="table table-bordered table-hover table-striped results">
                           ...
                           <tbody>
                            <?php 
                                //nawiazanie polaczenia i zapytanie do bazy danych
                                ...
                                if($ile_rekordow = $zapytanie -> num_rows>0){
                                    while($rekord = $zapytanie->fetch_object())
                                    {
                                        ...
                                        echo "<th>".$i."</th>";
                                        echo "<td><form method='post' action='czytaj_u.php'><input type='hidden' name='id' value='".$rekord->id_w."'><input type='hidden' name='id_user' value='".$rekord->id_user."'><input class='wiadomosc' type='submit' value='".$rekord->temat."'/></form></td>";
